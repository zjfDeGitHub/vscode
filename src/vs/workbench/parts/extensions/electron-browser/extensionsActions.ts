				...
				if (!isDisabled) {
					...
					if (this.extensionManagementServerService.otherExtensionManagementServer) {
						if (uiExtension) {
							...
							enableReload = installed.locals.some(local => this.extensionManagementServerService.getExtensionManagementServer(local.location).authority === this.extensionManagementServerService.otherExtensionManagementServer.authority);
						}
					}
